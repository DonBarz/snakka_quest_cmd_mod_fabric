...
public class QuestTypes {
    ...
    public static <T extends Quest> QuestType<T> register(String id, QuestType<T> beanType) {
        return Registry.register(QuestType.REGISTRY, Identifier.fromNamespaceAndPath(SnacksQuestMod.MOD_ID, id), beanType);
    }
}